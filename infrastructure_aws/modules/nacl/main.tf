...
# # internet -> External ALB / NACL: 1024-65535 (cho phép internet phản hồi) ok
...
#   protocol       = "tcp"
#   rule_action    = "allow"
#   cidr_block     = "0.0.0.0/0"   # hoặc thay bằng IP của bạn cho an toàn hơn
#   from_port      = 22
#   to_port        = 22
# }
...
# # NAT (Internet) -> App EC2: 1024-65535 (giúp app & web tải gói) ok
