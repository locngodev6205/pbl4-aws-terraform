...
#tfsec:ignore:aws-ec2-no-public-ingress-acl # Public subnets must allow web traffic from the internet
...
#tfsec:ignore:aws-ec2-no-public-ingress-acl # Allows return traffic from NAT Gateway
